...
*2024.12 ~ ing* 
>한성대학교 공식 애플리케이션을 개발하는 한성대학교 HSD(한성학생개발자)입니다. 한성대학교 정보화 팀과 협업을 통해 학생 및 교직원의 편의 도모를 위하여 주체적으로 아이디어 제안 및 개발에 참여하고 있습니다.
>교내 공식 서비스(스쿨버스, 혼잡도, HSU-API 등)를 개발 및 유지보수하며, Docker와 Nginx 기반의 안정적인 서버 인프라를 운영하고 있습니다.
...
> - `Java` `Spring Boot` `MySQL` `AWS (EC2/RDS/S3)` `Docker` `GitHub Actions` `Nginx`  

<br>

**🥇 2024.11 | 한성 SW중심대학 페스티벌 최우수상**  
> 💬 **펴닝(Pyeoning)** — *AI 기반 맞춤형 상담 서비스*
> 
> - **UI 디자인 및 화면 흐름 설계**  
> - **의사용 페이지 UI 구현 및 서버 통신 로직 개발**  
> - `JavaScript` `HTML` `CSS` `React` `Vercel`  
...
![H2](https://img.shields.io/badge/H2-808080?style=for-the-badge)
